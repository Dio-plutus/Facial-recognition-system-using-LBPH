...
while True:
        ...
        if face is not None:
            ...
            if results[1] < 500:
                ...
                employee_name = labels_to_name[matched_id]["full_name"]
                employee_id = labels_to_name[matched_id]["employee_id"]
                display_string  = "Name: {} ID: {}".format(employee_name, employee_id)
